...
To analyze the flight's data, several date and time functions were used in MySQL, including:
...
## Requirements
To run the SQL queries and analysis on the flight's dataset in MySQL, the following software and tools are required:
...
3. Create a new database and import the flight dataset into a new table.
